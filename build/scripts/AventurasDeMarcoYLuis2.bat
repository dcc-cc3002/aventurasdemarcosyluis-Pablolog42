...
@rem ##########################################################################
@rem
@rem  AventurasDeMarcoYLuis2 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and AVENTURAS_DE_MARCO_Y_LUIS2_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %AVENTURAS_DE_MARCO_Y_LUIS2_OPTS%  -classpath "%CLASSPATH%" aventurasdemarcoyluis.view.MainGUI %*
...
:fail
rem Set variable AVENTURAS_DE_MARCO_Y_LUIS2_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%AVENTURAS_DE_MARCO_Y_LUIS2_EXIT_CONSOLE%" exit 1
exit /b 1
